...
// Generado el: 2022.04.20 a las 08:15:48 PM CDT 
//
...
@XmlRootElement(name = "VerTareasResponse")
public class VerTareasResponse {

    @XmlElement(required = true)
    protected List<VerTareasResponse.Tarea> tarea;
     ...
     * {@link VerTareasResponse.Tarea }
     * 
     * 
     */
    public List<VerTareasResponse.Tarea> getTarea() {
        if (tarea == null) {
            tarea = new ArrayList<VerTareasResponse.Tarea>();
        }
        return this.tarea;
    }
