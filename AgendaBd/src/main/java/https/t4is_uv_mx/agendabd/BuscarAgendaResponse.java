...
public class BuscarAgendaResponse {
    ...
    protected List<BuscarAgendaResponse.Tarea> tarea;
     ...
     * {@link BuscarAgendaResponse.Tarea }
     * 
     * 
     */
    public List<BuscarAgendaResponse.Tarea> getTarea() {
        if (tarea == null) {
            tarea = new ArrayList<BuscarAgendaResponse.Tarea>();
        }
        return this.tarea;
    }
